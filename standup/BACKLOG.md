...
## demo_squad — demo-app
See `demo-app/BACKLOG.md` for ready-to-assign, well-scoped code tasks (truncate,
slugify max_length, top_words, title_case). Hand one to the team as a **code task**
from the portal (target `project:demo-app`).
